    ...
    observe({
      ...
      if (input$comparisons_view_rnaseq_norm %in% names(rv$top_table)){
        ...
        output$realdownload_Phistogram_rnaseq_norm <- downloadHandler(
          filename = function(){ifelse(input$static_Phistogram_rnaseq_norm, "Phistogram.png", "Phistogram.html")},
          content = function(file){
            
            if (input$static_Phistogram_rnaseq_norm){
          ...
          showModal(modalDialog(
            ...
            footer = tagList(
              fluidRow(
                column(12, align = "left",
                       shinyWidgets::materialSwitch(
                         inputId = "static_Phistogram_rnaseq_norm",
                         label = "Click to make static plot",
                         value = FALSE, 
                         status = "primary"))
              ),
              fluidRow(
                column(6,
                       conditionalPanel(
                         condition = "input.static_Phistogram_rnaseq_norm==true",
        ...
        output$realdownload_logFChistogram_rnaseq_norm <- downloadHandler(
          filename = function(){ifelse(input$static_logFChistogram_rnaseq_norm, "logFChistogram.png", "logFChistogram.html")},
          content = function(file){
            
            if (input$static_logFChistogram_rnaseq_norm){
          ...
          showModal(modalDialog(
            ...
            footer = tagList(
              fluidRow(
                column(12, align = "left",
                       shinyWidgets::materialSwitch(
                         inputId = "static_logFChistogram_rnaseq_norm",
                         label = "Click to make static plot",
                         value = FALSE, 
                         status = "primary"))
              ),
              fluidRow(
                column(6,
                       conditionalPanel(
                         condition = "input.static_logFChistogram_rnaseq_norm==true",
